import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.fb82000c.js";const p="/my-blog/assets/communication3-1.d19e8994.gif",o="/my-blog/assets/communication3-2.4e70f056.gif",m=JSON.parse('{"title":"Vue3 10种组件通讯方式","description":"","frontmatter":{"title":"Vue3 10种组件通讯方式"},"headers":[],"relativePath":"pages/front/vue/communication3.md","filePath":"pages/front/vue/communication3.md"}'),e={name:"pages/front/vue/communication3.md"},t=l(`<p>Vue3 10种组件通讯方式</p><h2 id="实现方式" tabindex="-1">实现方式 <a class="header-anchor" href="#实现方式" aria-label="Permalink to &quot;实现方式&quot;">​</a></h2><ol><li>Props</li><li>emits</li><li>expose / ref</li><li>v-model</li><li>插槽 slot</li><li>provide / inject</li><li>总线 bus</li><li>Pinia</li></ol><h3 id="props" tabindex="-1">Props <a class="header-anchor" href="#props" aria-label="Permalink to &quot;Props&quot;">​</a></h3><p><a href="https://cn.vuejs.org/guide/components/props.html" target="_blank" rel="noreferrer">props 文档</a></p><p>父组件传值给子组件（简称：父传子）</p><p>父组件</p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="color:#24292E;">}</span></span>
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">script</span><span style="color:#24292E;">&gt;</span></span></code></pre></div><p><code>Pinia</code> 还提供了多种语法糖，强烈建议阅读一下</p>`,125),c=[t];function r(E,y,i,d,F,g){return n(),a("div",null,c)}const A=s(e,[["render",r]]);export{m as __pageData,A as default};
